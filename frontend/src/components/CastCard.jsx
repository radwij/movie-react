function CastCard({person, movie}) {
  return (
    <div className="flex flex-col items-start flex-shrink-0 rounded-md hover:bg-gray-200 transition-colors duration-300 overflow-hidden">
      ...
      <div className="flex flex-col px-2 py-1">
        ...
        <p className="text-sm text-gray-500">as {person.character}</p>
      </div>
    </div>
  )
} 

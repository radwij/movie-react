  ...
  return (
    <nav className="w-full border-b border-gray-200">
      <div className="flex justify-between max-w-7xl px-8 py-5 mx-auto gap-x-10">
        ...
        <form className="flex search-form gap-x-3 whitespace-nowrap flex-grow h-fit" onSubmit={handleSearchSubmit}>
          <input
            type="text"
            placeholder="Look up something..."
            className="search-input w-full border-2 border-gray-200 h-10 px-5 py-2 rounded-3xl focus:outline-0 focus:border-blue-500 focus:border-3" onChange={(e) => setQuery(e.target.value)} />
